...
bool adiciona_arvore(Arvore *self, char valor);
bool remove_arvore(Arvore *self, char valor);
bool existe_arvore(Arvore *self, char valor);
...
bool adiciona_arvore(Arvore *self, char valor)
{
    if (!self->raiz)
    {
        self->cria_raiz(self, valor);
        return true;
    }

    if (self->existe(self, valor))
    {
        return false;
    }

    Node *other = cria_node(valor, NULL, NULL);
...
bool _remove_arvore(Node **self, char valor)
{
    if (*self == NULL)
    {
        return false;
...
bool _existe_arvore(Node *self, char valor)
{
    if (self == NULL)
    {
        return false;
